-- Declarative snapshot of the storage schema (E1 scope).
-- This file is NOT executed by the migration runner — it exists for
-- documentation, ER-diagrams and PR-review. The runner applies plain
-- SQL files from `migrations/`. Keep this snapshot in sync manually.
--
-- Scope: only the four E1 tables. Embeddings (E2a), events (E4),
-- notification_log/feedback_log (E5), projects (E2c) are intentionally
-- absent — see storage/CLAUDE.md section D.
